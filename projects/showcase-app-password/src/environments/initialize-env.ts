...
fs.writeFileSync('./projects/showcase-app-password/src/environments/env.ts', envContent);

const manifestContent = `{
  "id": "/",
  "name": "${proc.env['APP_PWA_NAME'] || 'Showcase Password App'}",
  "short_name": "${proc.env['APP_PWA_SHORT_NAME'] || 'showcase-app-password'}",
  "theme_color": "#ffffff",
...
fs.writeFileSync('./projects/showcase-app-password/public/manifest.webmanifest', manifestContent);
