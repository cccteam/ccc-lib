...
import { AlertType, BASE_URL, FRONTEND_LOGIN_PATH } from '@cccteam/resource-angular/types';
import { UiCoreService } from '@cccteam/resource-angular/ui-core-service';
import { CUSTOM_HTTP_REQUEST_OPTIONS } from '@cccteam/resource-angular/util-request-options';
