...
// Session returns the password authentication session handlers.
func (a *App) Session() session.PasswordAuthHandlers {
	return a.pwdSession
}

// Login returns the handler for authenticating a user with a username and password.
func (a *App) Login() http.HandlerFunc {
	return a.pwdSession.Login()
}
...
func (a *App) Assets() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		gui.Assets("../projects/showcase-app-password/dist").ServeHTTP(w, r)
	}
}
